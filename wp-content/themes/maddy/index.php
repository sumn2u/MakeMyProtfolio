    ...
    <section id="portfolio">
        <div class="container">
          ...
          <div class="row" style="text-align:center" >
            ...
            <!-- MeroServer Large Rect -->
            <ins class="adsbygoogle"
            style="display:inline-block;width:336px;height:280px"
            data-ad-client="ca-pub-9012000723262944"
            data-ad-slot="7307542918"></ins>
            <script>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>I like to call myself as a technology enthusiast and sometime a hacker. I do lots of research and is active in several communities in Kathmandu.</p>
                </div>
                <div class="col-lg-4">
